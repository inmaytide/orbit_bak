...
public class FormAuthenticationProvider implements AuthenticationProvider {
    ...
    public static void main(String... args) {
        System.out.println(new BCryptPasswordEncoder(DEFAULT_PASSWORD_ENCODER_STRENGTH).encode("adsfsadfasfasdfasfasdfadsfsdafasfsdajkfhaskdjfsahkfjahsdjkfahsjkhaskfjhasdkfj"));
    }
